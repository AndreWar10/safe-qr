...
class Logger {
  ...
  static Future<void> debug(String message, {String? tag, Map<String, dynamic>? metadata}) async {
  ...
  static Future<void> success(String message, {String? tag, Map<String, dynamic>? metadata}) async {
  ...
  static Future<void> error(String message, {String? tag, Map<String, dynamic>? metadata, StackTrace? stackTrace}) async {
    await _service.error(message, tag: tag, metadata: metadata, stackTrace: stackTrace);
  }

  /// Log de erro com exceção
  static Future<void> errorWithException(String message, dynamic exception, {String? tag}) async {
